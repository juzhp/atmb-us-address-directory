...
export const alt = 'Anytime Mailbox (ATMB) tutorial — filter real US residential addresses';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          {['Registration', 'Address Filter', 'Credit Card / Bank'].map((tag) => (
            <div
              key={tag}
              style={{
                display: 'flex',
