...
const defaultFooterLinks = [
  { href: "/", label: "首页" },
  // { href: "/locations", label: "地址列表" },
  // { href: "/admin/login", label: "后台登录" }
];

export function SiteShell({ children, rightSlot = null, navLinks = [], footerLinks = defaultFooterLinks }) {
  return (
    <div className={styles.page}>
      <header className={styles.nav}>
        ...
        <div className={styles.rightRail}>
          ...
          >
            <span>获得美国住宅地址</span>
            <span className={styles.hotBadge}>火爆</span>
          </a>
          <a
            href={githubUrl}
            target="_blank"
  ...
  if (item.external) {
    return (
      ...
      >
        ...
        {item.hot ? <span className={styles.hotBadge}>火爆</span> : null}
      </a>
    );
  }
